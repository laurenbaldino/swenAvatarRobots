...
(cl:defmethod emotion-val ((m <AddTwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorials-srv:emotion-val is deprecated.  Use beginner_tutorials-srv:emotion instead.")
  (emotion m))

(cl:ensure-generic-function 'sensor_id-val :lambda-list '(m))
(cl:defmethod sensor_id-val ((m <AddTwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorials-srv:sensor_id-val is deprecated.  Use beginner_tutorials-srv:sensor_id instead.")
  (sensor_id m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<AddTwoInts-request>)))
  ...
  "7c82105cb5cdc3d55e658c0fea7184bb")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'AddTwoInts-request)))
  "Returns md5sum for a message object of type 'AddTwoInts-request"
  "7c82105cb5cdc3d55e658c0fea7184bb")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<AddTwoInts-request>)))
  ...
  (cl:format cl:nil "string emotion~%string sensor_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'AddTwoInts-request)))
  "Returns full string definition for message of type 'AddTwoInts-request"
  (cl:format cl:nil "string emotion~%string sensor_id~%~%~%"))
...
(cl:defmethod resp-val ((m <AddTwoInts-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader beginner_tutorials-srv:resp-val is deprecated.  Use beginner_tutorials-srv:resp instead.")
  (resp m))
